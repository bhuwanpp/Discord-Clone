    ...
    <div className="root-layout">
      <header className=" bg-bgColor flex justify-between items-center h-20 px-10">
        ...
        <nav className="lg:flex hidden  justify-between gap-8 text-white font-semibold">
          <Link smooth to="home" className="cursor-pointer hover:underline">
            Download
          </Link>
          <Link smooth to="about" className="cursor-pointer hover:underline">
            Nitro
          </Link>
          <Link smooth to="services" className="cursor-pointer hover:underline">
            Discover
          </Link>
          <Link smooth to="services" className="cursor-pointer hover:underline">
            Safety
