    ...
    return (
      <div className="home h-[530px] bg-bgColor overflow-hidden" id="home">
        ...
        <div className="left  absolute -left-96">
          ...
          <h1 className="text-center text-6xl font-black text-white pb-10 w-ful">IMAGINE A PLACE...</h1>
          <p className="text-center text-white text-lg pb-10">...where you can belong to a school club, a gaming group, or a worldwide art community. Where just you and a handful of friends can spend time together. A place that makes it easy to talk every day and hang out more often.</p>
          <div className="buttons flex  items-center justify-center gap-10">
            <button className="bg-white flex px-7 py-3 text-xl rounded-full">
              <div className="icons text-2xl pr-2">
              <iconify-icon icon="material-symbols:download"></iconify-icon>
              </div>
              Download for Windows</button>
            <button className="bg-black text-white flex px-7 py-3 text-xl rounded-full opacity-80">Open discord in your browser</button>
          </div>
          </div>
